...
public class GateController {
    ...
    public ResponseDto openGates(@RequestParam(name = "parkingLotId") @NonNull Long parkingLotId,
                                 @RequestParam(name = "operatorId") @NonNull Long operatorId) throws ApplicationException {
    ...
    public ResponseDto closeGates(@RequestParam(name = "parkingLotId") @NonNull Long parkingLotId,
                                  @RequestParam(name = "operatorId") @NonNull Long operatorId) throws ApplicationException {
        ResponseDto responseDto = new ResponseDto();
