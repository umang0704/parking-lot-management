...
public class AES256CryptoConverter {
  ...
  public static String encrypt(String plainText) throws ApplicationException {
    try {
      ...
      throw new ApplicationException(
          ResponseCode.PL_500102, exception, "Error Encryption of personal Data.");
    }
  }
  ...
  public static String decrypt(String encryptedText) throws ApplicationException {
    try {
      ...
      throw new ApplicationException(
          ResponseCode.PL_500102, exception, "Error Decryption of personal Data.");
    }
  }
  ...
  //            System.arraycopy(hashedKey, 0, correctedKey, 0, Math.min(hashedKey.length,
  // correctedKey.length));
  //
  //            return correctedKey;
  //        }catch (NoSuchAlgorithmException exception){
  //            throw new ApplicationException(ResponseCode.PL_500102,exception,"Error
