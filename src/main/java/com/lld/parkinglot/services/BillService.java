...
public class BillService {
    ...
    @Autowired
    private BillCreationStrategyFactory billCreationStrategyFactory;
    ...
    private static Bill createBillAndSetBasicDetails(Date exitTime, Gate exitGate, Operator operator, Ticket ticket) {
        Bill bill = new Bill();
    ...
    private void calculateAndSetBill(Bill bill) {
        BillAmountCreationStrategy billCreationFactory = billCreationStrategyFactory.getBillCreationFactory(BillCreationStrategyTypes.DURATION);
    ...
    private static BillDto createBillDto(Ticket ticket, Bill bill) {
        ...
        billDto.setAmount(String.valueOf(new StringBuilder().append(bill.getAmountPartWhole()).append(".").append(bill.getAmountPartDecimal())));
